...
class Complexity_labeller:
	...
	def get_dataframe(self):
	    ...
	    for sentence_ids_in_batch in batches_of_sentence_ids:
	        ...
	        cost, predicted_labels, predicted_probs = self.model.process_batch(batch, is_training=False, learningrate=0.0)
	    try:
	    ...
	    annotated_sentences['sentences'] = annotated_sentences['sentences'].apply(lambda sentence: [pair[0] for pair in sentence])
